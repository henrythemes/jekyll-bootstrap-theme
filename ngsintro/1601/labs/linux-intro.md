...
```bash
$ salloc -A g2016001 -t 07:00:00 -p core -n 1 --no-shell --reservation=g2016001_20160125 &
```
...
This course's project id is **g2016001**, so the path to the project folder is **/proj/g2016001**
...
The files are located in the folder **/proj/g2016001/labs/linux_tutorial**
...
$ cp -r /proj/g2016001/labs/linux_tutorial/* ~/glob/ngs-intro/linux_tutorial
```
...
$ nano /proj/g2016001/labs/linux_additional-files/large_file
```
...
$ head /proj/g2016001/labs/linux_additional-files/large_file
```
...
$ head -n 23 /proj/g2016001/labs/linux_additional-files/large_file
```
...
$ tail /proj/g2016001/labs/linux_additional-files/large_file

$ tail -n <number of rows to view> <filename>

$ tail -n 23 /proj/g2016001/labs/linux_additional-files/large_file
```
