...
$ Trinity --seqType fa --left /proj/g2016001/labs/transcriptome_assembly/mouse_left.fasta --right /proj/g2016001/labs/transcriptome_assembly/mouse_right.fasta --SS_lib_type RF --CPU 8 --max_memory 16G --output trinity_out/
```
