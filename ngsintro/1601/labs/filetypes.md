...
```bash
$ salloc -A g2016001 -t 07:00:00 -p core -n 1 --no-shell --reservation=g2016001_20160126 &
```
...
The files are located in the folder `/proj/g2016001/labs/filetypes`
...
$ cp -r /proj/g2016001/labs/filetypes ~/glob/ngs-intro/
```
