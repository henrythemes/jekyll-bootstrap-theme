...
```bash
$ salloc -A g2016008 -t 07:00:00 -p core -n 1 --no-shell --reservation=g2016008_25 &
```
...
The files are located in the folder **/proj/g2016008/labs/linux_tutorial**
...
$ cp -r /proj/g2016008/labs/linux_tutorial/* ~/glob/ngs-intro/linux_tutorial
```
...
$ nano /proj/g2016008/labs/linux_additional-files/large_file
```
...
$ head /proj/g2016008/labs/linux_additional-files/large_file
```
...
$ head -n 23 /proj/g2016008/labs/linux_additional-files/large_file
```
...
$ tail /proj/g2016008/labs/linux_additional-files/large_file

$ tail -n <number of rows to view> <filename>

$ tail -n 23 /proj/g2016008/labs/linux_additional-files/large_file
```
