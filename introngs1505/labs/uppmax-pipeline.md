...
* Align the filtered reads with the program align\_reads, to the human reference genome located here: /sw/data/uppnex/reference/Homo_sapiens/hg19/concat\_rm/Homo\_sapiens.GRCh37.57.dna\_rm.concat.fa
