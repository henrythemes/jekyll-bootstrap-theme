...
The files are located in the folder `/proj/g2015037/labs/uppmax_pipeline_exercise`
...
$ cp -r /proj/g2015037/labs/uppmax_pipeline_exercise ~/glob/ngs-intro/
```
...
```bash
$ export PATH=$PATH:/proj/g2015037/labs/uppmax_pipeline_exercise/dummy_scripts
```
