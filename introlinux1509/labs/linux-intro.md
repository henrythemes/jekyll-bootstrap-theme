...
This course's project id is **g2015037**, so the path to the project folder is **/proj/g2015037**
...
The files are located in the folder **/proj/g2015037/labs/linux_tutorial**
...
$ cp -r /proj/g2015037/labs/linux_tutorial/* ~/glob/ngs-intro/linux_tutorial
```
...
$ nano /proj/g2015037/labs/linux_additional-files/large_file
```
...
$ head /proj/g2015037/labs/linux_additional-files/large_file
```
...
$ head -n 23 /proj/g2015037/labs/linux_additional-files/large_file
```
...
$ tail /proj/g2015037/labs/linux_additional-files/large_file

$ tail -n <number of rows to view> <filename>

$ tail -n 23 /proj/g2015037/labs/linux_additional-files/large_file
```
